...
export default function Badge({ children, variant = 'default', className }: BadgeProps) {
  return (
    <span className={cn(
      ...
      variant === 'default' && 'bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400',
      ...
      variant === 'outline' && 'border border-neutral-200 dark:border-neutral-700 text-neutral-500 dark:text-neutral-400',
      className,
    )}>
      {children}
    </span>
