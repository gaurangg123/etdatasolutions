...
export default function ContactForm() {
  ...
  const handleChange = (
    ...
    if (errors[e.target.name]) {
      setErrors((er) => { const n = { ...er }; delete n[e.target.name]; return n; });
    }
  };
    ...
    <form className={styles.form} onSubmit={handleSubmit} noValidate>
      ...
      <div className={styles.field}>
        ...
        <input
          ...
          placeholder="Company name (optional)" autoComplete="organization"
      ...
      <div className={styles.row}>
        ...
        <div className={styles.field}>
          ...
          <select id="budget" name="budget" value={form.budget} onChange={handleChange} disabled={disabled}>
