  ...
  return (
    <section className="relative overflow-hidden py-20 md:py-28 bg-white dark:bg-ink-950">
      ...
      <div className={cn('relative max-w-[1180px] mx-auto px-6', centered && 'text-center')}>
        ...
        <motion.h1 {...fade(0.08)} className="text-4xl md:text-5xl lg:text-[3.6rem] font-[800] tracking-[-0.04em] leading-[1.07] text-ink-900 dark:text-ink-50 mb-5 max-w-[700px]">
          {title}
        </motion.h1>
        <motion.p {...fade(0.16)} className={cn('text-lg text-ink-500 dark:text-ink-400 leading-relaxed max-w-[520px]', centered && 'mx-auto')}>
          {subtitle}
        </motion.p>
      </div>
    </section>
