  ...
  return (
    <footer className="bg-neutral-50 dark:bg-[#0a0908] border-t border-neutral-200 dark:border-neutral-800">
      <div className="max-w-container mx-auto px-5 sm:px-6">
        ...
        {/* Mini CTA bar */}
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 py-6 border-b border-neutral-200 dark:border-neutral-800">
          <div>
            ...
            <p className="text-xs text-neutral-400 dark:text-neutral-500">Free consultation · No contract · 30-day guarantee</p>
          </div>
          <Link
            href="/contact#form"
            className="flex-shrink-0 inline-flex items-center gap-2 text-sm font-[700] text-white bg-brand-500 hover:bg-brand-600 px-5 py-2.5 rounded-xl transition-all duration-150 hover:-translate-y-px hover:shadow-[0_4px_16px_rgba(232,68,10,0.4)]"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr] gap-10 md:gap-16 py-12 border-b border-neutral-200 dark:border-neutral-800">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="text-base font-[700] tracking-[-0.02em] text-neutral-800 dark:text-neutral-200">
                ET Data Solutions
              </span>
            </div>

            {/* Positioning statement */}
            <p className="text-sm text-neutral-500 dark:text-neutral-400 leading-relaxed max-w-[280px] mb-2">
            ...
            <p className="text-xs text-neutral-400 dark:text-neutral-500 mb-6">
              99% accuracy · 24/7 operations · 100+ clients worldwide
            </p>
            ...
            <div className="flex flex-col gap-2.5">
              {[
                ...
                <div key={item.label} className="flex items-center gap-2.5">
                  <item.icon size={13} className="text-brand-500 flex-shrink-0" aria-hidden />
                  {item.href ? (
                    <a href={item.href} className="text-sm text-neutral-500 dark:text-neutral-400 hover:text-brand-500 transition-colors duration-150">
                      {item.label}
                    </a>
                  ) : (
            ...
            <div className="flex flex-col gap-2.5">
              {serviceLinks.map(l => (
                <Link
                  key={l.href}
                  href={l.href}
                  className="text-sm text-neutral-500 dark:text-neutral-400 hover:text-brand-500 transition-colors duration-150"
                >
                  {l.label}
                </Link>
              ))}
