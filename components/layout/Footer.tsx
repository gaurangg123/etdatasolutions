        ...
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr] gap-10 md:gap-14 py-12 border-b border-ink-200 dark:border-ink-800">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-3">
              ...
              <div>
                <span className="block text-[0.875rem] font-[750] tracking-[-0.02em] text-ink-900 dark:text-ink-200">ET Data Solutions</span>
            ...
            <div className="flex flex-col gap-2.5">
              {contacts.map(c => (
                <div key={c.label} className="flex items-center gap-2.5">
                  ...
                  {c.href
                    ? <a href={c.href} className="text-xs text-ink-500 dark:text-ink-400 hover:text-brand-500 transition-colors duration-150">{c.label}</a>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              {serviceLinks.map(l => (
                <Link key={l.href} href={l.href} className="text-sm text-ink-500 dark:text-ink-400 hover:text-brand-500 transition-colors duration-150">
                  {l.label}
                </Link>
              ))}
            </div>
