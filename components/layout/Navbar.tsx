...
export default function Navbar() {
  ...
  return (
    <>
          ...
          <Link href="/" className="flex items-center gap-2.5 flex-shrink-0 group min-w-0">
            ...
            <div className="hidden sm:flex items-center gap-3 min-w-0">
              <div className="min-w-0">
                <span className="block text-[0.9375rem] font-[750] tracking-[-0.02em] text-ink-900 dark:text-ink-50 group-hover:text-brand-500 transition-colors leading-tight">ET Data Solutions</span>
                <span className="block text-[0.65rem] text-ink-400 dark:text-ink-500 font-[500] tracking-[0.03em] leading-tight">Outsourcing · Est. 2014</span>
              </div>
      ...
      {open && <div className="fixed inset-0 z-[190] bg-ink-950/25 dark:bg-ink-950/50 backdrop-blur-sm md:hidden" onClick={() => setOpen(false)} aria-hidden />}
