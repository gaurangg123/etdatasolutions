      ...
      <div className="container">
        <div className={styles.splitGrid}>
          <div className={styles.splitText}>
            ...
            <Reveal delay={0.14}><p>Since 2014, we've built a team in Indore, India that operates as a calm extension of yours — no scope drift, no surprise invoices, no chase-ups. Just work that arrives finished.</p></Reveal>
            ...
            <Reveal delay={0.28}>
              <div className={styles.badges}>
                {['🇺🇸 United States','🇬🇧 United Kingdom','🇨🇦 Canada','🇦🇺 Australia'].map(b => <span key={b} className={styles.badge}>{b}</span>)}
              </div>
            </Reveal>
          ...
          <Reveal delay={0.14} className={styles.splitImageWrap}>
            <div className={styles.imageStack}>
              <div className={styles.imgMain}>
                <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=600&h=420&fit=crop&q=82" alt="Team collaborating" loading="lazy" />
              </div>
              <div className={styles.imgAccent}>
                <img src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=280&h=180&fit=crop&q=80" alt="Office team" loading="lazy" />
              </div>
