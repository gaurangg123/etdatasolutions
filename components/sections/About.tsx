      ...
      <div className="container">
        ...
        <div className={styles.splitGrid}>
          <div className={styles.splitText}>
            ...
            <Reveal delay={0.14}>
              <p>Since 2014, we've built a team in Indore, India that operates as a calm extension of yours — no scope drift, no surprise invoices, no chase-ups. Just work that arrives finished.</p>
            </Reveal>
            <Reveal delay={0.21}>
              <p style={{ marginTop: '14px' }}>We serve clients in the US, UK, Canada, and Australia — working in your timezone, in your tools, at your pace.</p>
            </Reveal>
            <Reveal delay={0.28}>
              <div className={styles.badges}>
                <span className={styles.badge}>🇺🇸 United States</span>
                <span className={styles.badge}>🇬🇧 United Kingdom</span>
                <span className={styles.badge}>🇨🇦 Canada</span>
                <span className={styles.badge}>🇦🇺 Australia</span>
              </div>
            </Reveal>
            <Reveal delay={0.35}>
              <Link href="/about" className={styles.learnMore}>Learn our story →</Link>
            </Reveal>
          </div>
          ...
          <Reveal delay={0.14} className={styles.splitImageWrap}>
            <div className={styles.imageStack}>
              <div className={styles.imgMain}>
                <img
                  src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=600&h=420&fit=crop&q=82"
              ...
              <div className={styles.imgAccent}>
                <img
                  src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=280&h=180&fit=crop&q=80"
