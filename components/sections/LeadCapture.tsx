                ...
                <>
                  ...
                  <form onSubmit={submit} className="p-7 flex flex-col gap-4" noValidate>
                    {[
                      ...
                      <div key={f.key}>
                        <label className="block text-[0.72rem] font-[700] tracking-[0.07em] uppercase text-ink-400 dark:text-ink-500 mb-1.5">
                          {f.label}{f.required && ' *'}
                        </label>
                        <input
                          ...
                          className="w-full bg-ink-50 dark:bg-ink-800 border border-ink-200 dark:border-ink-700 rounded-xl px-4 py-3 text-sm text-ink-900 dark:text-ink-100 placeholder:text-ink-400 dark:placeholder:text-ink-600 focus:outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/15 transition-all"
                        />
                      </div>
                    ))}
                    ...
                    <button
                      ...
                      className="group w-full inline-flex items-center justify-center gap-2 text-[0.925rem] font-[700] text-white bg-brand-500 hover:bg-brand-600 disabled:opacity-60 py-3.5 rounded-xl transition-all duration-200 hover:shadow-brand hover:-translate-y-px active:scale-[0.97] shine mt-1"
                    >
                      {loading
