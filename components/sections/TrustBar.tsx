      ...
      >
        <div className="flex w-max animate-marquee">
          {[...logos, ...logos, ...logos].map((l, i) => (
            <span
              key={i}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-ink-200 dark:border-ink-700 bg-white dark:bg-ink-900 text-sm font-[500] text-ink-600 dark:text-ink-300 shadow-xs whitespace-nowrap select-none mx-2"
            >
