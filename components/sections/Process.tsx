    ...
    <Section bg="white" label="Our process">
      <Container>
        ...
        <div className="relative">
          ...
          <div aria-hidden className="hidden lg:block absolute top-[28px] left-[calc(10%+12px)] right-[calc(10%+12px)] h-px bg-gradient-to-r from-ink-200 via-brand-500/30 to-ink-200 dark:from-ink-800 dark:via-brand-500/20 dark:to-ink-800" />

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 relative">
            {steps.map((s, i) => (
              <AnimateIn key={s.n} delay={i * 0.09}>
        ...
        <AnimateIn delay={0.35} className="mt-10 text-center">
          <Button href="/contact#form" variant="primary" size="lg" arrow className="shine">
