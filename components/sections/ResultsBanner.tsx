...
const metrics = [
  ...
  { to:100, suffix:'+',  label:'Clients served globally',bg:'100' },
  { to:7,   suffix:'',   label:'Days to first delivery', extra:'days', bg:'7' },
        ...
        {metrics.map((m,i) => (
          <div key={i} className={styles.cell}>
            ...
            <div className={styles.numWrap}>
              <Counter to={m.to} suffix={m.suffix} decimals={m.decimals??0} duration={1600} className={styles.num}/>
