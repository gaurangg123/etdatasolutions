...
export default function FinalCTA() {
  return (
    <Section bg="white" size="md" label="Get started">
      <Container>
        {/* Item 30: AnimateIn wraps the entire block for scroll-triggered fade */}
        <AnimateIn>
          <div className="relative rounded-[28px] overflow-hidden">
            ...
            <div className="relative z-10 px-8 py-20 md:px-20 text-center">
              {/* Item 33: pulsing live indicator badge */}
              ...
              <h2 className="text-[2rem] sm:text-[2.8rem] md:text-[3.4rem] font-[800] tracking-[-0.04em] text-white leading-[1.08] mb-5 text-balance max-w-[580px] mx-auto">
              ...
              {/* CTAs — item 3: clear primary/secondary */}
