...
export default function Hero() {
  ...
  return (
    <section id="hero" ref={ref} className="relative overflow-hidden bg-white dark:bg-ink-950">
      ...
      <div aria-hidden className="hidden dark:block absolute inset-0 pointer-events-none" style={{background:'radial-gradient(ellipse 80% 60% at 65% -5%, rgba(232,68,10,0.14) 0%, transparent 65%), radial-gradient(ellipse 50% 50% at 20% 70%, rgba(14,28,50,0.6) 0%, transparent 70%)'}} />
        ...
        <Container className="py-12 md:py-16 lg:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] xl:grid-cols-[1fr_430px] gap-10 xl:gap-16 items-center">
            ...
            <div>
              ...
              <motion.h1 {...f(0.07)}
                className="font-[850] tracking-[-0.045em] leading-[1.05] text-ink-900 dark:text-white text-balance mb-4 text-[2.4rem] sm:text-[3rem] md:text-[3.4rem] lg:text-[3.6rem] xl:text-[4rem]">
                Your team should be{' '}
              ...
              <motion.p {...f(0.13)} className="text-[1rem] md:text-[1.075rem] text-ink-500 dark:text-ink-400 leading-[1.65] max-w-[500px] mb-2">
