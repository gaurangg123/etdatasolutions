...
/**
 * Two prominent scroll-triggered narrative blocks.
 * Verbatim copy provided by the brand.
 */
export default function MissionStatement() {
  return (
    <section className="relative isolate overflow-hidden bg-white">
      ...
      {/* BLOCK 1 — the cost-effective outsourcing alternative */}
      ...
      {/* BLOCK 2 — where we work + what we do globally */}
      <div className="container-x py-24 sm:py-32 lg:py-40 relative">
...
/* ── Abstract animated background field ── */
      ...
      <svg className="absolute inset-0 w-full h-full opacity-[0.07]" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="grid" width="60" height="60" patternUnits="userSpaceOnUse">
            <path d="M 60 0 L 0 0 0 60" fill="none" stroke="#FF7A00" strokeWidth="1" />
          </pattern>
        </defs>
...
function DataFlowGraphic() {
  ...
  return (
    <svg viewBox="0 0 320 280" className="w-full h-auto">
      ...
      <motion.circle
        cx={250} cy={180} r={22}
        fill="none" stroke="#FF7A00" strokeWidth="2"
...
/* ── Global reach graphic: globe + service rings ── */
function GlobalReachGraphic() {
  return (
    <svg viewBox="0 0 320 280" className="w-full h-auto">
      ...
      <motion.circle
        cx="160" cy="140" r="110"
        fill="none" stroke="url(#gg)" strokeWidth="1.5" strokeDasharray="3 6"
        initial={{ rotate: 0 }}
        animate={{ rotate: 360 }}
      ...
      {/* latitudes */}
      <ellipse cx="160" cy="140" rx="72" ry="22" fill="none" stroke="#FF7A00" strokeWidth="1.2" opacity="0.5" />
      <ellipse cx="160" cy="140" rx="60" ry="60" fill="none" stroke="#FF7A00" strokeWidth="1.2" opacity="0.3" />
      <line x1="88" y1="140" x2="232" y2="140" stroke="#FF7A00" strokeWidth="1.2" opacity="0.5" />
      <line x1="160" y1="68" x2="160" y2="212" stroke="#FF7A00" strokeWidth="1.2" opacity="0.5" />
      ...
      {[
        ...
        >
          <circle cx={p.x} cy={p.y} r="10" fill="#FF7A00" />
