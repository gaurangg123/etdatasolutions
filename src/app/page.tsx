          ...
          <div className={`${styles.servicesGrid} reveal reveal-delay-3`}>
            {services.map(svc => (
              <Link key={svc.id} href={`/services#${svc.id}`} className={styles.svcCard}>
                ...
                <p className={styles.svcDesc}>{svc.description.slice(0, 115)}…</p>
        ...
        <div className="container">
          <div className={styles.whyLayout}>
            <div className={styles.whyLeft}>
              ...
              <p className="section-sub reveal reveal-delay-2">
                All personnel are constantly monitored for quality. Operators,
                supervisors, trainers, verifiers and QC specialists — all trained
                to ensure the highest possible accuracy, every single time.
              </p>
            ...
            <div className={styles.whyRight}>
              {[
                ...
                { icon: 'clock', title: 'Any Scale, Any Timeline',    desc: 'Short or long-term. A single project or an ongoing relationship. We adapt to you.'     },
                { icon: 'lock',  title: 'Secure & Confidential',      desc: 'Utmost integrity and security for all time-critical, information-sensitive assignments.' },
            ...
            <div className={styles.ctaContent}>
              ...
              <div className={styles.ctaActions}>
                ...
                <a href="mailto:bobby@etdatasolutions.com" className="btn-secondary"
                  style={{ borderColor: 'rgba(255,255,255,0.3)', color: 'rgba(255,255,255,0.88)' }}>
