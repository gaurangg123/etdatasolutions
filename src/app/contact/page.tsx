...
export default function ContactPage() {
  ...
  return (
    <>
      ...
      {/* ─── MAIN LAYOUT — id="form" so #form anchor works ─── */}
              ...
              {status === 'sent' ? (
                ...
                <div className={styles.successBox}>
                  ...
                  <p className={styles.successSub}>
                    ...
                    <a href="mailto:bobby@etdatasolutions.com" style={{ color: 'var(--accent)' }}>
                      bobby@etdatasolutions.com
                    </a>
                    {' '}or call <a href="tel:+13023579776" style={{ color: 'var(--accent)' }}>+1-302-357-9776</a>.
                  </p>
