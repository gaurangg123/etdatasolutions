...
import {
  ...
  MessageSquare, ChevronDown, ArrowRight, ClipboardList,
} from 'lucide-react'
...
export default function ContactPageClient() {
  return (
    <>
      <section id="form" className="py-14 md:py-20 bg-white dark:bg-ink-950">
        <Container>
      ...
      {/* FREE AUDIT CTA CARD */}
      <section id="audit" className="pb-16 md:pb-20 bg-white dark:bg-ink-950">
        <Container>
          <AnimateIn>
            <div className="bg-brand-50 dark:bg-brand-500/10 border border-brand-200 dark:border-brand-500/20 rounded-3xl p-8 md:p-10 flex flex-col md:flex-row items-start md:items-center gap-6 justify-between">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-2xl bg-brand-100 dark:bg-brand-500/20 border border-brand-200 dark:border-brand-500/30 flex items-center justify-center text-brand-500 flex-shrink-0">
                  <ClipboardList size={22} />
                </div>
                <div>
                  <h3 className="text-lg font-[750] text-ink-900 dark:text-ink-100 mb-1">Prefer a structured conversation first?</h3>
                  <p className="text-sm text-ink-500 dark:text-ink-400 leading-relaxed max-w-[480px]">
              ...
              <a
                href="mailto:bobby@etdatasolutions.com?subject=Free Operations Audit Request"
                className="flex-shrink-0 inline-flex items-center gap-2 text-sm font-[700] text-white bg-brand-500 hover:bg-brand-600 px-6 py-3 rounded-xl transition-all duration-200 hover:-translate-y-px hover:shadow-brand shine"
              >
