...
function AboutSection() {
  return (
    <section id="about" className="bg-ink-50 dark:bg-[#0a0908]">
      {/* Page-header strip */}
      <div className="relative overflow-hidden py-20 md:py-28 bg-white dark:bg-ink-950">
      ...
      {/* Story + Stats card */}
      <div className="py-16 md:py-24 bg-white dark:bg-ink-950">
        <Container>
...
function ContactSection() {
  return (
    <section id="contact" className="bg-ink-50 dark:bg-[#0a0908]">
      ...
      <div id="form" className="py-16 md:py-24 bg-white dark:bg-ink-950">
        <Container>
