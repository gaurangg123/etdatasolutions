...
const config: Config = {
  ...
  safelist: [
    ...
    'dark:bg-violet-500/10','dark:text-violet-400','dark:border-violet-500/25',
    'bg-sky-50','text-sky-600','border-sky-200','border-l-sky-500',
    'dark:bg-sky-500/10','dark:text-sky-400','dark:border-sky-500/25',
    'bg-emerald-50','text-emerald-600','border-emerald-200','border-l-emerald-500',
    'dark:bg-emerald-500/10','dark:text-emerald-400','dark:border-emerald-500/25',
    'bg-amber-50','text-amber-600','border-amber-200','border-l-amber-500',
    'dark:bg-amber-500/10','dark:text-amber-400','dark:border-amber-500/25',
    // Ring colors
    'ring-sky-200','ring-emerald-200','ring-violet-200','ring-amber-200',
    'dark:ring-sky-500/30','dark:ring-emerald-500/30','dark:ring-violet-500/30','dark:ring-amber-500/30',
    // Contact icon colors
    'bg-sky-500/10','text-sky-500','border-sky-100','dark:border-sky-500/20',
    'bg-violet-500/10','text-violet-500','border-violet-100',
    'bg-emerald-500/10','text-emerald-500','border-emerald-100',
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'card-hover':'0 4px 16px rgba(0,0,0,0.07), 0 20px 48px rgba(0,0,0,0.09)',
        lifted:      '0 2px 8px rgba(0,0,0,0.06), 0 8px 24px rgba(0,0,0,0.08)',
      },
